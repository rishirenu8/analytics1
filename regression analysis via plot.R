...
fitted(fit2)#predicted values for price and promotion

?fitted
omni$sales#actual sales
residuals(fit2)#diff between actual and predicted
...
plot(fit2,3)  # No hetero-scedascity #google heterosedacity
