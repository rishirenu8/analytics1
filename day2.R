...
read1 = read.csv(file="./data/rishi.csv", header = TRUE,sep = ",")
read1
...
url_gsheet = "https://docs.google.com/spreadsheets/d/1xP93MuIBI7YpnFrEh1fThRIz_tAtulDja7ps0np7ZJE/edit?usp=sharing"
df_gsheet = as.data.frame(gsheet2tbl(url_gsheet))
head(df_gsheet)
